...
INSERT IGNORE INTO sites (site_id, name, description, address, city, postalCode, country_id, nbseatsc1, nbseatsc2, nbseatsc3) VALUES (1, 'Stade de France', 'Stadium for the opening and closing ceremony, seven-players rugby, and athletism', 'Stade de France', 'Saint-Denis', '93216', 1, 10000, 3000, 1000);
INSERT IGNORE INTO sites (site_id, name, description, address, city, postalCode, country_id, nbseatsc1, nbseatsc2, nbseatsc3) VALUES (2, 'The Seine river', 'Place for opening ceremony', 'The Seine river', 'Saint-Denis', '93216', 1, 20000, 5000, 2000);
INSERT IGNORE INTO sites (site_id, name, description, address, city, postalCode, country_id, nbseatsc1, nbseatsc2, nbseatsc3) VALUES (3, 'Olympic swimming-pool', 'Place for swimming, diving and water-polo', 'Piscine Georges-Vallerey, 148 av. Gambetta', 'Saint-Denis', '93216', 1, 20000, 5000, 2000);
INSERT IGNORE INTO sites (site_id, name, description, address, city, postalCode, country_id, nbseatsc1, nbseatsc2, nbseatsc3) VALUES (4, 'Urban Park at The Concorde', 'Place for the opening ceremony for paralympic games, basket-ball 3x3, BMX freestyle, breakdance and skateboard', 'Concorde square', 'Paris', '93000', 1, 20000, 5000, 2000);
INSERT IGNORE INTO sites (site_id, name, description, address, city, postalCode, country_id, nbseatsc1, nbseatsc2, nbseatsc3) VALUES (5, 'Stadium Pierre-Mauroy', 'Place for the opening ceremony for paralympic games', 'Stade Pierre-Mauroy', 'Lille', '59000', 1, 20000, 5000, 2000);
INSERT IGNORE INTO sites (site_id, name, description, address, city, postalCode, country_id, nbseatsc1, nbseatsc2, nbseatsc3) VALUES (6, 'Stadium of La Beaujoire', 'Place for football matches', 'Stade de la Beaujoire', 'Nantes', '44000', 1, 20000, 5000, 2000);
INSERT IGNORE INTO sites (site_id, name, description, address, city, postalCode, country_id, nbseatsc1, nbseatsc2, nbseatsc3) VALUES (7, 'Stadium Allianz Riviera of Nice ', 'Place for the football matches', 'Stade de Nice', 'Nice', '06000', 1, 20000, 5000, 2000);
INSERT IGNORE INTO sites (site_id, name, description, address, city, postalCode, country_id, nbseatsc1, nbseatsc2, nbseatsc3) VALUES (8, 'Stadium of Bordeaux', 'Place for football matches', 'Stade de Bordeaux', 'Bordeaux', '33000', 1, 20000, 5000, 2000);
INSERT IGNORE INTO sites (site_id, name, description, address, city, postalCode, country_id, nbseatsc1, nbseatsc2, nbseatsc3) VALUES (9, 'Velodrome Stadium Of Marseille', 'Place for paralympic football games', 'Stadium of Marseille', 'Marseille', '13000', 1, 20000, 5000, 2000);
INSERT IGNORE INTO sites (site_id, name, description, address, city, postalCode, country_id, nbseatsc1, nbseatsc2, nbseatsc3) VALUES (10, 'Olympic Park of Lyon', 'Place for paralympic football matches', 'Stade de Lyon', 'Lyon', '69000', 1, 20000, 5000, 2000);
INSERT IGNORE INTO sites (site_id, name, description, address, city, postalCode, country_id, nbseatsc1, nbseatsc2, nbseatsc3) VALUES (11, 'Stadium of Roland-Garros', 'Place for tennis and boxe matches', 'Roland-Garros', 'Paris', '78000', 1, 20000, 5000, 2000);
INSERT IGNORE INTO sites (site_id, name, description, address, city, postalCode, country_id, nbseatsc1, nbseatsc2, nbseatsc3) VALUES (12, 'Stadium of Bercy', 'Place for basket-ball, trampoline, rhythmic gymnastics', 'Stade de Bercy', 'Paris', '75000', 1, 20000, 5000, 2000);
INSERT IGNORE INTO sites (site_id, name, description, address, city, postalCode, country_id, nbseatsc1, nbseatsc2, nbseatsc3) VALUES (13, 'Invalid Esplanade', 'Place for the archery competition', 'Invalid Esplanade', 'Paris', '76000', 1, 20000, 5000, 2000);
INSERT IGNORE INTO sites (site_id, name, description, address, city, postalCode, country_id, nbseatsc1, nbseatsc2, nbseatsc3) VALUES (14, 'Great Palace', 'Place for the taekwondo and fencing meetings', 'Grand Palais', 'Paris', '78000', 1, 20000, 5000, 2000);
INSERT IGNORE INTO sites (site_id, name, description, address, city, postalCode, country_id, nbseatsc1, nbseatsc2, nbseatsc3) VALUES (15, 'Porte de Versailles Exhibition Center', 'Place for the table-tennis, volleyball, handball and weightlifting meetings', 'Porte de Versailles Exhibition Center', 'Paris', '78000', 1, 20000, 5000, 2000);
