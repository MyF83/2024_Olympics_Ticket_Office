...
INSERT INTO sites (site_id, name, description, address, city, postalCode, country_id, nbseatsc1, nbseatsc2, nbseatsc3) VALUES (1, 'Stade de France', 'Stadium for the opening and closing ceremony, seven-players rugby, and athletism', 'Stade de France', 'Saint-Denis', '93216', 1, 10000, 3000, 1000);
INSERT INTO sites (site_id, name, description, address, city, postalCode, country_id, nbseatsc1, nbseatsc2, nbseatsc3) VALUES (2, 'The Seine river', 'Place for opening ceremony', 'The Seine river', 'Saint-Denis', '93216', 1, 20000, 5000, 2000);
INSERT INTO sites (site_id, name, description, address, city, postalCode, country_id, nbseatsc1, nbseatsc2, nbseatsc3) VALUES (3, 'Olympic swimming-pool', 'Place for swimming, diving and water-polo', 'Piscine Georges-Vallerey, 148 av. Gambetta', 'Saint-Denis', '93216', 1, 20000, 5000, 2000);
INSERT INTO sites (site_id, name, description, address, city, postalCode, country_id, nbseatsc1, nbseatsc2, nbseatsc3) VALUES (4, 'Urban Park at The Concorde', 'Place for the opening ceremony for paralympic games, basket-ball 3x3, BMX freestyle, breakdance and skateboard', 'Concorde square', 'Paris', '93000', 1, 20000, 5000, 2000);
INSERT INTO sites (site_id, name, description, address, city, postalCode, country_id, nbseatsc1, nbseatsc2, nbseatsc3) VALUES (5, 'Stadium Pierre-Mauroy', 'Place for the opening ceremony for paralympic games', 'Stade Pierre-Mauroy', 'Lille', '59000', 1, 20000, 5000, 2000);
INSERT INTO sites (site_id, name, description, address, city, postalCode, country_id, nbseatsc1, nbseatsc2, nbseatsc3) VALUES (6, 'Stadium of La Beaujoire', 'Place for football matches', 'Stade de la Beaujoire', 'Nantes', '44000', 1, 20000, 5000, 2000);
INSERT INTO sites (site_id, name, description, address, city, postalCode, country_id, nbseatsc1, nbseatsc2, nbseatsc3) VALUES (7, 'Stadium Allianz Riviera of Nice ', 'Place for the football matches', 'Stade de Nice', 'Nice', '06000', 1, 20000, 5000, 2000);
INSERT INTO sites (site_id, name, description, address, city, postalCode, country_id, nbseatsc1, nbseatsc2, nbseatsc3) VALUES (8, 'Stadium of Bordeaux', 'Place for football matches', 'Stade de Bordeaux', 'Bordeaux', '33000', 1, 20000, 5000, 2000);
INSERT INTO sites (site_id, name, description, address, city, postalCode, country_id, nbseatsc1, nbseatsc2, nbseatsc3) VALUES (9, 'Velodrome Stadium Of Marseille', 'Place for paralympic football games', 'Stadium of Marseille', 'Marseille', '13000', 1, 20000, 5000, 2000);
INSERT INTO sites (site_id, name, description, address, city, postalCode, country_id, nbseatsc1, nbseatsc2, nbseatsc3) VALUES (10, 'Olympic Park of Lyon', 'Place for paralympic football matches', 'Stade de Lyon', 'Lyon', '69000', 1, 20000, 5000, 2000);
INSERT INTO sites (site_id, name, description, address, city, postalCode, country_id, nbseatsc1, nbseatsc2, nbseatsc3) VALUES (11, 'Stadium of Roland-Garros', 'Place for tennis and boxe matches', 'Roland-Garros', 'Paris', '78000', 1, 20000, 5000, 2000);
INSERT INTO sites (site_id, name, description, address, city, postalCode, country_id, nbseatsc1, nbseatsc2, nbseatsc3) VALUES (12, 'Stadium of Bercy', 'Place for basket-ball, trampoline, rhythmic gymnastics', 'Stade de Bercy', 'Paris', '75000', 1, 20000, 5000, 2000);
INSERT INTO sites (site_id, name, description, address, city, postalCode, country_id, nbseatsc1, nbseatsc2, nbseatsc3) VALUES (13, 'Invalid Esplanade', 'Place for the archery competition', 'Invalid Esplanade', 'Paris', '76000', 1, 20000, 5000, 2000);
INSERT INTO sites (site_id, name, description, address, city, postalCode, country_id, nbseatsc1, nbseatsc2, nbseatsc3) VALUES (14, 'Great Palace', 'Place for the taekwondo and fencing meetings', 'Grand Palais', 'Paris', '78000', 1, 20000, 5000, 2000);
INSERT INTO sites (site_id, name, description, address, city, postalCode, country_id, nbseatsc1, nbseatsc2, nbseatsc3) VALUES (15, 'Porte de Versailles Exhibition Center', 'Place for the table-tennis, volleyball, handball and weightlifting meetings', 'Porte de Versailles Exhibition Center', 'Paris', '78000', 1, 20000, 5000, 2000);


-- Insert offers 
INSERT INTO offers (offer_id, title, description, image, rate, nbSpectators) VALUES (1, 'Solo Offer', 'Get 5% off with the Solo Offer', 'png/Solo.png', 5, 1);
INSERT INTO offers (offer_id, title, description, image, rate, nbSpectators) VALUES (2, 'Duo Offer', 'A 15% off for a 2-persons discount ticket', 'png/Duo.png', 15, 2);
INSERT INTO offers (offer_id, title, description, image, rate, nbSpectators) VALUES (3, 'Family Offer', 'Get 35% off with a 4-persons family Offer', 'png/Family.png', 35, 4);

-- Insert policies 
INSERT INTO policies (policy_id, title, description, url, creationDate, version, isActive) VALUES (1, 'Security Policies', 'Policies of the Olympic Games Ticketing System : every user of this application must have a secure password. In the case not, may encounter many years in jail !', 'policies/policy_1.html', '2023-10-01', 1, false);
INSERT INTO policies (policy_id, title, description, url, creationDate, version, isActive) VALUES (2, 'Security Policies', 'Policies of the Olympic Games Ticketing System (version 2) : every user of this application must have a secure password. In the case not, may encounter many years in jail !','policies/policy_2.html', '2024-02-23', 2, true);
...
INSERT INTO keysgenerations (key_id, keyGenerated) VALUES (1, '');
INSERT INTO keysgenerations (key_id, keyGenerated) VALUES (2, '');
INSERT INTO keysgenerations (key_id, keyGenerated) VALUES (3, '');
INSERT INTO keysgenerations (key_id, keyGenerated) VALUES (4, '');
...
-- INSERT INTO challengers (challenger_id, name, country_id) VALUES (1, 'Francois Bellando', null);
 ...
 INSERT INTO challengers (challenger_id, name, country_id) VALUES (28, 'Dinesh Kapoor,', 20);
 INSERT INTO challengers (challenger_id, name, country_id) VALUES (29, 'Priya Sharma', 20);
 INSERT INTO challengers (challenger_id, name, country_id) VALUES (30, 'Rajesh Patel', 20);
 INSERT INTO challengers (challenger_id, name, country_id) VALUES (31, 'Caroline Janson', 1);
 INSERT INTO challengers (challenger_id, name, country_id) VALUES (32, "French Men's Rugby Sevens Team", 1);
 INSERT INTO challengers (challenger_id, name, country_id) VALUES (33, 'Equipe de France féminine de plongeon', 1);
 INSERT INTO challengers (challenger_id, name, country_id) VALUES (34, "French women's diving team", 1);
 INSERT INTO challengers (challenger_id, name, country_id) VALUES (35, "French men's swimming team", 1);
 INSERT INTO challengers (challenger_id, name, country_id) VALUES (36, "U.S. Men's Swimming Team", 13);
 INSERT INTO challengers (challenger_id, name, country_id) VALUES (37, "Swedish men's diving team", 3);
 INSERT INTO challengers (challenger_id, name, country_id) VALUES (38, "Swedish women's diving team", 3);
 INSERT INTO challengers (challenger_id, name, country_id) VALUES (39, "Swedish women's volleyball team", 3);
 INSERT INTO challengers (challenger_id, name, country_id) VALUES (40, "French women's volleyball team", 1);
...
INSERT INTO sports (sport_id, name, description, isParalympic, site_id) VALUES (1, 'Swimming', 'Swimming olympic games competition', false, 3);
INSERT INTO sports (sport_id, name, description, isParalympic, site_id) VALUES (2, 'Archery', 'Archery olympic games competition', true, 13);
INSERT INTO sports (sport_id, name, description, isParalympic, site_id) VALUES (3, 'Table-tennis', 'Table-tennis olympic games competition', false, 15);
INSERT INTO sports (sport_id, name, description, isParalympic, site_id) VALUES (4, 'Volleyball', 'Volleyball olympic games competition', true, 15); 
INSERT INTO sports (sport_id, name, description, isParalympic, site_id) VALUES (5, 'Handball', 'Handball olympic games competition', false, 15);
INSERT INTO sports (sport_id, name, description, isParalympic, site_id) VALUES (6, 'Taekwondo', 'Taekwondo olympic games competition', false, 14);    
INSERT INTO sports (sport_id, name, description, isParalympic, site_id) VALUES (7, 'Fencing', 'Fencing olympic games competition', true, 14);        
INSERT INTO sports (sport_id, name, description, isParalympic, site_id) VALUES (8, 'Boxing', 'Boxing olympic games competition', true, 11); 
INSERT INTO sports (sport_id, name, description, isParalympic, site_id) VALUES (9, 'Football', 'Football olympic games competition', true, 7); 
INSERT INTO sports (sport_id, name, description, isParalympic, site_id) VALUES (10, 'BMX freestyle', 'BMX freestyle olympic games competition', true, 4);
...
-- INSERT INTO userselections (usersel_id, nb_persons, amount, offer_id, event_id) VALUES (1, 3, 457.25, null, null);
INSERT INTO userselections (usersel_id, nbPersons, amount, offer_id, event_id) VALUES (1, 1, 457.25, 1, 1);
INSERT INTO userselections (usersel_id, nbPersons, amount, offer_id, event_id) VALUES (2, 1, 851.55, 1, 1);
INSERT INTO userselections (usersel_id, nbPersons, amount, offer_id, event_id) VALUES (3, 3, 851.55, 2, 1);
INSERT INTO userselections (usersel_id, nbPersons, amount, offer_id, event_id) VALUES (4, 4, 851.55, 3, 1);
...
-- INSERT INTO userskeys (userkey_id, date, user_id, key_id) VALUES (1, '2022-03-12', null, 1);
...
INSERT INTO carts (cart_id, date, totalAmount, user_id) VALUES (1, '2024-03-12', 1257.30, 3);
INSERT INTO carts (cart_id, date, totalAmount, user_id) VALUES (2, '2024-03-13', 328.90, 2);
INSERT INTO carts (cart_id, date, totalAmount, user_id) VALUES (3, '2024-03-20', 726.20, 4);
...
-- INSERT INTO tickets (ticket_id, date, key_assembly, file_name, userkey_id, salekey_id, sale_id, cart_id, user_id, usersel_id) VALUES (1, '2024-05-03', '', '6d4106d1d3da4970a54146c3f9de2976d6c0c151', 3, 1, 1, 1, 3, 1);
INSERT INTO tickets (ticket_id, date, keyAssembly, fileName, sale_id) VALUES (1, '2024-05-03', '', '6d4106d1d3da4970a54146c3f9de2976d6c0c151', 1);
INSERT INTO tickets (ticket_id, date, keyAssembly, fileName, sale_id) VALUES (2, '2024-05-03', '', '6d4106d1d3da4970a54146c3f9de2976d6c0c151', 2);
INSERT INTO tickets (ticket_id, date, keyAssembly, fileName, sale_id) VALUES (3, '2024-05-03', '', '6d4106d1d3da4970a54146c3f9de2976d6c0c151', 3);
...
-- INSERT INTO offers (offer_id, title, description, image, rate, nb_spectators) VALUES (2, 'Duo Offer', 'A 15% off for a 2-persons discount ticket', 'png/Duo.png', 15, 2);
...
-- -- Insert policies 
-- INSERT INTO policies (policy_id, title, description, url, creation_date, version, is_active) VALUES (1, 'Security Policies', 'Policies of the Olympic Games Ticketing System : every user of this application must have a secure password. In the case not, may encounter many years in jail !', 'policies/policy_1.html', '2023-10-01', 1, false);
-- INSERT INTO policies (policy_id, title, description, url, creation_date, version, is_active) VALUES (2, 'Security Policies', 'Policies of the Olympic Games Ticketing System (version 2) : every user of this application must have a secure password. In the case not, may encounter many years in jail !','policies/policy_2.html', '2024-02-23', 2, true);
...
-- -- Insert userselections 
-- -- INSERT INTO userselections (usersel_id, nb_persons, amount, offer_id, event_id) VALUES (1, 3, 457.25, null, null);
-- INSERT INTO userselections (usersel_id, nb_persons, amount, offer_id, event_id) VALUES (1, 1, 457.25, 1, 1);
-- INSERT INTO userselections (usersel_id, nb_persons, amount, offer_id, event_id) VALUES (2, 1, 851.55, 1, 1);
-- INSERT INTO userselections (usersel_id, nb_persons, amount, offer_id, event_id) VALUES (3, 3, 851.55, 2, 1);
-- INSERT INTO userselections (usersel_id, nb_persons, amount, offer_id, event_id) VALUES (4, 4, 851.55, 3, 1);
